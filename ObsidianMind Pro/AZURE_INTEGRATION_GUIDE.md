...
ObsidianMind Pro รองรับการเชื่อมต่อกับ **Azure AI Services** เพื่อเพิ่มความสามารถด้าน AI และการแปลภาษา:
...
### 🔧 **ขั้นตอนที่ 1: สร้าง Azure Translator Resource**

#### **ใน Azure Portal:**
1. ไปที่ [Azure Portal](https://portal.azure.com)
2. คลิก "Create a resource"
3. ค้นหา "Translator"
4. เลือก "Translator" service
5. กรอกข้อมูล:
   ```
