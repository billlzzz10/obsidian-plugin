...
1. **ดาวน์โหลดปลั๊กอิน**
   ...
   - แตกไฟล์ ZIP เพื่อรับโฟลเดอร์ 'obsidian-ai-plugin'
...
2. **ติดตั้งใน Obsidian**
   ...
   - คัดลอกโฟลเดอร์ 'obsidian-ai-plugin' ลงในไดเร็กทอรี 'plugins'

3. **เปิดใช้งานปลั๊กอิน**
   - เปิดออบซิเดียน
   - ไปที่การตั้งค่า (⚙️) →ปลั๊กอินชุมชน
   - ค้นหา "Obsidian AI Plugin" ในรายการปลั๊กอินที่ติดตั้ง
   - สลับเปิด
...
1. **ปลั๊กอินไม่โหลด**
   - ตรวจสอบให้แน่ใจว่าโฟลเดอร์มีชื่อว่า 'obsidian-ai-plugin'
   - ตรวจสอบว่าไฟล์ทั้งหมดอยู่ในโครงสร้างไดเร็กทอรีที่ถูกต้อง
